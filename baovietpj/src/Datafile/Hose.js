...
const getReactResults = () =>
    axios.get('https://online.bvsc.com.vn/datafeed/instruments?exchange=HOSE').then(res =>
        res.data.d
    );

export default class Hose extends React.Component {
    state = { results: [] };
                    ...
                    <>
                        <tbody>
                            <tr key={i}>
                                ...
                                <td className="td-thamchieu">{(Math.round(item.ceiling * 100) / 100).toLocaleString()}</td>
                                <td className="td-tran">{(Math.round(item.floor * 100) / 100).toLocaleString()}</td>
                                <td className="td-san">{(Math.round(item.reference * 100) / 100).toLocaleString()}</td>
                                ...
                                <td className="red-color">{(Math.round(item.closeVol * 100) / 100).toLocaleString()}</td>
                                ...
                                <td className="red-color">{(Math.round(item.offerVol1 * 100) / 100).toLocaleString()}</td>
                                <td className="red-color">{(Math.round(item.offerPrice2 * 100) / 100).toLocaleString()}</td>
                                <td className="red-color">{(Math.round(item.offerVol2 * 100) / 100).toLocaleString()}</td>
